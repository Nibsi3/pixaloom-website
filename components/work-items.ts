...
The platform combines structured CAPS-aligned content, interactive lessons, practice, and authentic past papers—with live-style analytics and an admin workflow for creating/managing learning resources and reporting across subjects.`,
    ...
    url: 'https://www.capstutor.co.za',
    gallery: [
      '/pixa_pics/capstutor/capstutor-homepage.png',
      '/pixa_pics/capstutor/capstutor-modes.png',
      '/pixa_pics/capstutor/capstutor-exercises.png',
      '/pixa_pics/capstutor/capstutor-analytics.png',
      '/pixa_pics/capstutor/capstutor-caps.png',
      '/pixa_pics/capstutor/capstutor-ieb.png',
      '/pixa_pics/capstutor/capstutor-cambridge.png',
      '/pixa_pics/capstutor/capstutor-pricing.png',
      '/pixa_pics/capstutor/capstutor-trial.png',
    ],
  },
  {
    slug: 'paws-on-route',
